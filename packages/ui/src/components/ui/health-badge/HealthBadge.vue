...
<template>
  <span
    class="inline-flex items-center gap-1.5 rounded-full bg-background px-2 py-1 font-mono text-[10px] font-medium leading-none tracking-wider uppercase ring-1"
    :class="[s.text, s.ring]"
  >
