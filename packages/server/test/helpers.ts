...
const TABLES = ['artifact', 'test', 'run', 'project', 'subscription', 'slack_integration', 'invitation', 'member', 'organization', 'apikey', 'device_code', 'verification', 'account', 'session', 'user']
